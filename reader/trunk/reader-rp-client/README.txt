...
the jar file (main class org.accada.reader.rp.client.TestClient is started).

In order to be able to display notifications from the reader execute the class
org.accada.reader.rp.client.EventSinkUI in jar file using the following command:
