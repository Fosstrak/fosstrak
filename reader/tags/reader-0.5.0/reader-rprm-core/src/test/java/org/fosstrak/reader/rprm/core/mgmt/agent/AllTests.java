...
/**
 * All tests for package <code>org.fosstrak.reader.mgmt.agent</code> and its subpackages.
 */
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTest(AgentTestSuite.suite());
		suite.addTest(org.fosstrak.reader.rprm.core.mgmt.agent.snmp.AllTests.suite());
