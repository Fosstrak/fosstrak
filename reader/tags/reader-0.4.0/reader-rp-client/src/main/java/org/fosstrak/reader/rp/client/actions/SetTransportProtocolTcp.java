...
public class SetTransportProtocolTcp extends AbstractAction {
	
	private TestClient parent;
	
	public SetTransportProtocolTcp(TestClient parent) {
		super("TCP");
		this.parent = parent;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		handshake.setTransportProtocol(Handshake.TCP);
	}
