...
/**
 * All tests for package <code>org.accada.reader.mgmt.agent</code> and its subpackages.
 */
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTest(org.accada.reader.rprm.core.mgmt.agent.snmp.AllTests.suite());
