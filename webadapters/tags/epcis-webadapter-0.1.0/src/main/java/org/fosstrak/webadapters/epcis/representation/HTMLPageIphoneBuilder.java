...
/**
 * Class to build the HTML iPhone Representation of a EPCISResource
...
public class HTMLPageIphoneBuilder extends HTMLBuilder {
    ...
    /**
     * Validation of the ease of building another Interface upon the EPCIS Webadapter with just adding some javascript and css and minor changing the html (better change with DOM)
     *
     *
     * @param resource
     *
    ...
    public String buildRepresentation(EPCISResource resource) {
        ...
        String        myName        = "EPCIS Webadapter Mobile";
        String        myHomeURI     = "#";
        String        myParentURI   = "#";
        String        myDescription = "EPCIS Webadapter Mobile";
        ...
        res.append("<title>Fosstrak EPCIS Webadapter Mobile UI</title>");
