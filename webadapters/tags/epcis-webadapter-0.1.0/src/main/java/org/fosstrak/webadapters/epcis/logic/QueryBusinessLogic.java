...
import org.fosstrak.webadapters.epcis.rest.IQueryResource;
...
public class QueryBusinessLogic extends AbstractQueryParamBusinessLogic implements IQueryResource {
    ...
    public EPCISResource getSelectedBusinessLocation(UriInfo context, String businessLocation) {
        ...
        EPCISResource resource = setUpResource(context, name, description, path, businessLocation);
    ...
    public EPCISResource getSelectedReadPoint(UriInfo context, String businessLocation, String readPoint) {
        ...
        EPCISResource resource = setUpResource(context, name, description, path, businessLocation, readPoint);
    ...
    public EPCISResource getSelectedEventTime(UriInfo context, String businessLocation, String readPoint, String eventTime) {
        ...
        EPCISResource resource = setUpResource(context, name, description, path, businessLocation, readPoint, eventTime);
    ...
    public EPCISResource getEvent(UriInfo context, String businessLocation, String readPoint, String eventTime, String index) {
        ...
        if (index.equals("0")) {
            ...
            EPCISResource searchedEventsResource = getResults(context, eventTime, null, null, null, null, null, readPoint, null, businessLocation, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    public EPCISResource getEpc(UriInfo context, String businessLocation, String readPoint, String eventTime, String index, String epc) {
        ...
        EPCISResource resource = setUpResource(context, name, description, path, businessLocation, readPoint, eventTime, epc);
    ...
    public EPCISResource getBusinessTransaction(UriInfo context, String businessLocation, String readPoint, String eventTime, String index, String businessTransaction) {
        ...
        EPCISResource resource = setUpResource(context, name, description, path, businessLocation, readPoint, eventTime, businessTransaction);
     ...
     * @return an instance of EPCISResource
     */
    public EPCISResource getResultsXmlOnly(UriInfo context, String eventTime, String recordTime, String eventType, String action, String bizStep, String disposition, String readPoint, String readPointWD, String bizLocation, String bizLocationWD, String bizTransaction, String epc, String parentID, String anyEPC, String epcClass, String quantity, String fieldname, String orderBy, String orderDirection, String eventCountLimit, String maxEventCount) {
