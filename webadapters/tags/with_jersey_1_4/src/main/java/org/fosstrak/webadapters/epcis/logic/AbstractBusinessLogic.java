 ...
 * Encapsulates common EPCISResource handling logic.
 *
...
public abstract class AbstractBusinessLogic {
     ...
     * @return
     */
    public static EPCISResource setUpResource(UriInfo context, String name, String description, String path, Object... args) {

        if (!isInitialized) {
            isInitialized = true;
            Initializer.initializeRESTfulEPCIS(context);
        }
        EPCISResource resource = new EPCISResource();
