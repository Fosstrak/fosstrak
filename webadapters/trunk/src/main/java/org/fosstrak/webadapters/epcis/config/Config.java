...
//  public static final String QUERY_TimeZoneOffset_USAGE = CAPTURE_TimeZoneOffset_USAGE;
    ...
    // EPCIS Webadapter URL (will be set on the first request to be deployable everywhere)
    private static String RESTFUL_EPCIS_URL;
    private static String RESTFUL_EPCIS_URL_NO_VERSION;

    /**
     * Gets the EPCIS Webadapter URL
     *
     *
     * @return
     */
    ...
    /**
     * Gets the EPCIS Webadapter URL without a version number.
     *
     *
     * @return
     */
    ...
    /**
     * Sets the EPCIS Webadapter URL without a version number.
     *
     *
     * @param url
     */
    ...
    /**
     * Gets the EPCIS Webadapter Repository URL
     *
     *
     * @return
     */
    ...
    /**
     * Sets the EPCIS Webadapter Repository URL
     *
     *
     * @param url
     */
    ...
    /**
     * Gets the EPCIS Webadapter Repository Query URL
     *
     *
     * @return
     */
    ...
    /**
     * Sets the EPCIS Webadapter Repository Query URL
     *
     *
     * @return
     */
    ...
    /**
     * Gets the EPCIS Webadapter Resources URL
     *
     *
     * @return
     */
    ...
    public static final String FEED_AUTHORS = APP_NAME + " Team";
    public static final String FEED_CATEGORY = "Electronic Product Code Information Service Feed";
    public static final String FEED_CONTRIBUTOR = APP_NAME + ", Fosstrak Project";
