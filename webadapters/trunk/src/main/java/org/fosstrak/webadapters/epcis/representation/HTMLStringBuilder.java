...
public class HTMLStringBuilder {
    ...
    public static String buildContainerBody(String title, String treeMenu, String content, String uri) {
        ...
        res.append("</td>");
        res.append("<td>");
        res.append("<img src='" + URI.addSubPath(Config.GET_RESOURCES_URL(), "/images/web_adapter_logo_small_white.png") + "' height='100' alt='EPCIS Webadapter Logo' border='0' usemap='#MapLogo' /><map name='MapLogo' id='MapLogo'><area shape='rect' coords='0,0,131,100' href='" + Config.GET_RESTFUL_EPCIS_URL() + "' alt='EPCIS Webadapter'/></map>");
        res.append("</td>");
        res.append("</tr>");
        res.append("</table>");
        res.append("</div>");
     ...
     * @return
     */
    public static String buildTreeMenu(EPCISResource resource) {
        StringBuilder res      = new StringBuilder();
