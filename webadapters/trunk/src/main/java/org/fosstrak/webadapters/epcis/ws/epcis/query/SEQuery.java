 ...
 */
package org.fosstrak.webadapters.epcis.ws.epcis.query;

import org.fosstrak.webadapters.epcis.ws.epcis.queryparam.*;
...
public class SEQuery {
    ...
    /**
     * Overrided toString method (content are the EPCIS Webadapter query parameters)
     *
     *
     * @return
     */
    ...
    /**
     * Like the overrided toString method (content are the EPCIS Webadapter query parameters). But prints it human readable (pretty).
     *
     *
     * @return
     */
