...
import org.fosstrak.webadapters.epcis.feed.AtomPub;
import org.fosstrak.webadapters.epcis.feed.FeedResource;
...
import org.fosstrak.webadapters.epcis.representation.HTML;
import org.fosstrak.webadapters.epcis.rest.ISubscriptionResource;
import org.fosstrak.webadapters.epcis.rest.RESTfulEPCIS;
import org.fosstrak.webadapters.epcis.util.ActualDateTime;
...
import org.fosstrak.webadapters.epcis.ws.generated.QuerySchedule;
import org.fosstrak.webadapters.epcis.ws.generated.Subscribe;
import org.fosstrak.webadapters.epcis.ws.generated.SubscriptionControls;
...
public class SubscriptionBusinessLogic extends AbstractQueryParamBusinessLogic implements ISubscriptionResource {
     ...
     * @return an instance of EPCISResource
     */
    public EPCISResource getSubscriptions(UriInfo context) {
     ...
     * @return an instance of EPCISResource
     */
    public EPCISResource getSubscription(UriInfo context, String id) {
     ...
     * @return an instance of EPCISResource
     */
    public EPCISResource addEntryToSubscription(UriInfo context, String id, String entry) {
        id = URI.unescapeURL(id);
     ...
     * @return an instance of EPCISResource
     */
    public EPCISResource unsubscribeSubscription(UriInfo context, String id, String data) {
        id = URI.unescapeURL(id);
